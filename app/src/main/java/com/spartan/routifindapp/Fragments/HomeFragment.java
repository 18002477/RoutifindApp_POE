...
import com.spartan.routifindapp.Activity.DirectionActivity;
import com.spartan.routifindapp.Adapter.GooglePlaceAdapter;
import com.spartan.routifindapp.Adapter.InfoWindowAdapter;
import com.spartan.routifindapp.Constant.AllConstant;
import com.spartan.routifindapp.GooglePlaceModel;
import com.spartan.routifindapp.Model.GooglePlaceModel.GoogleResponseModel;
import com.spartan.routifindapp.NearLocationInterface;
import com.spartan.routifindapp.Permissions.AppPermissions;
import com.spartan.routifindapp.PlaceModel;
import com.spartan.routifindapp.R;
import com.spartan.routifindapp.SavedPlaceModel;
import com.spartan.routifindapp.Utility.LoadingDialog;
import com.spartan.routifindapp.WebServices.RetrofitAPI;
import com.spartan.routifindapp.WebServices.RetrofitClient;
...
GoogleMap.OnMarkerClickListener, NearLocationInterface {
    ...
    public void getPlaces(String placeName)
    {
            ...
            locationReference.child(googlePlaceModel.getPlaceId()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (!snapshot.exists()) {
                        ...
                        {
                            Toast.makeText(getContext(), "Previous location Still saving. Try again!", Toast.LENGTH_SHORT).show();
                        }
