...
import com.spartans.routifindapp.databinding.FragmentEmailChangeBinding;
import com.spartans.routifindapp.databinding.FragmentEmailConfirmationBinding;
...
public class EmailConfirmationFragment extends Fragment {
    ...
    private boolean validateFields()
    {
        ...
        if (email.isEmpty()) {
            binding.edtCEmail.setError("Email field is required");
            flag = true;
            requestView = binding.edtCEmail;
        } else if (password.isEmpty()) {
            binding.edtCPassword.setError("Password field is required");
            flag = true;
            requestView = binding.edtCPassword;
        } else if (password.length() < 8) {
            binding.edtCPassword.setError("Enter a minimum of 8 characters");
            flag = true;
            requestView = binding.edtCPassword;
        }
