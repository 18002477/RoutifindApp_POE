...
import com.spartans.routifindapp.databinding.FragmentPasswordChangeBinding;
...
public class PasswordChangeFragment extends Fragment {
    ...
    private boolean areFieldReady()
    {
        ...
        if (password.isEmpty()) {
            binding.edtUPassword.setError("Password Field is required");
            flag = true;
            requestView = binding.edtUPassword;
        } else if (password.length() < 8) {
            binding.edtUPassword.setError("Enter a minimum of 8 characters");
            flag = true;
            requestView = binding.edtUPassword;
        }
